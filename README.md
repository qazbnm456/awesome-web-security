...
- [Pompelmi](https://github.com/pompelmi/pompelmi) - In-process file upload security for Node.js that scans untrusted uploads before storage to detect malware, MIME spoofing, and risky archives.
