...
- [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) - Zero-configuration WordPress bot detection with WebDriver detection, headless browser fingerprinting, behavioral analysis, and SHA-256 proof-of-work challenges by [@WebDecoy](https://github.com/WebDecoy).
