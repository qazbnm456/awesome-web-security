...
- [ZeroTrust](https://github.com/sattyamjjain/zerotrust) - Privacy-first Chrome extension that analyzes website security locally using on-device AI (WebGPU), generating trust scores based on HTTPS, phishing, malicious scripts, and cookie compliance.
