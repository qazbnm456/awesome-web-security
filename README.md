...
- [VulnHawk](https://github.com/momenbasel/vulnhawk) - AI-powered code security scanner that catches missing auth, IDOR, business logic flaws, and inconsistent validation across PHP, Python, Ruby, JS/TS, Go, and Java by [@momenbasel](https://github.com/momenbasel).
