...
- [Trust Scan](https://github.com/undeadlist/trust-scan) - URL security scanner with threat intelligence (URLhaus, PhishTank, Spamhaus) and 40+ scam/phishing pattern detection by [@undeadlist](https://github.com/undeadlist).
