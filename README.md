...
- [ClawSec](https://clawsec.com/) - Security audit platform for AI agent skills with 5-tier analysis including Firecracker sandbox execution by [@anthropic-security](https://github.com/anthropic-security).
